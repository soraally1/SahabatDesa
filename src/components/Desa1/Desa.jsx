      ...
      <div className="max-w-7xl mx-auto px-8 py-24 space-y-32">
        ...
        >
          <h2 className="text-5xl font-black text-green-800 mb-8 tracking-tight 
            ...
            Tentang Desa Pagaitan
          </h2>
          <p className="text-gray-700 text-xl leading-relaxed max-w-4xl font-light">
            Desa Pagaitan di Sulawesi Utara adalah pionir dalam transformasi digital pedesaan Indonesia. 
            Dengan visi menjadi smart village terdepan, kami memadukan kearifan lokal dengan teknologi modern 
            untuk menciptakan ekosistem digital yang mendukung pertumbuhan ekonomi dan kesejahteraan masyarakat.
          </p>
        </motion.div>
