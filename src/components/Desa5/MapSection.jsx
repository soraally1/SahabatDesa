  ...
  >
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div className="lg:col-span-2 h-[500px]">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15937.027454741547!2d115.6945833!3d3.9183333!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x320e479bdf5e7c63%3A0x9d4e32e1ec9b4f0!2sLong%20Bawan%2C%20Krayan%2C%20Nunukan%20Regency%2C%20North%20Kalimantan!5e0!3m2!1sen!2sid!4v1704766774247!5m2!1sen!2sid"
          width="100%"
          height="100%"
          style={{ border: 0 }}
          allowFullScreen=""
        ...
        <div className="space-y-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Desa Long Bawan, Kecamatan Krayan, Kabupaten Nunukan, Kalimantan Utara</p>
            </div>
          </div>
          <div className="flex items-start gap-4">
            <div className="bg-green-100 p-3 rounded-lg">
            ...
            <div>
              ...
              <p className="text-gray-600">3.9183333, 115.6945833</p>
            </div>
          </div>
          <div className="flex items-start gap-4">
            <div className="bg-green-100 p-3 rounded-lg">
            ...
            <div>
              ...
              <p className="text-gray-600">3,500+ Penduduk</p>
            </div>
          </div>
          <div className="flex items-start gap-4">
            <div className="bg-green-100 p-3 rounded-lg">
            ...
            <div>
              ...
              <p className="text-gray-600">Beras Adan, Ekowisata, Kerajinan Dayak</p>
            </div>
          </div>
        </div>
      </div>
