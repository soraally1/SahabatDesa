    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-green-100/80">
      ...
      <div className="max-w-7xl mx-auto px-8 py-24 space-y-32">
        ...
        >
          ...
          ( karena namanya belum ada ) untuk memfokuskan pengembangan pembangunan di wilayah tersebut dengan jarak 1 km kesemua arah dan menyuruh penduduk yang ada di kampung sekelilingnya untuk pindah kewilayah tersebut untuk membangun di wilayah tersebut. 
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-green-100 text-xl mb-10 max-w-2xl mx-auto leading-relaxed">
            Jadilah bagian dari transformasi digital Desa Pusat Damai Bersama-sama kita 
          ...
          >
            <span>Dukung Desa Pusat Damai</span>
