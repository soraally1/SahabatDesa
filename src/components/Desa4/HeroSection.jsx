  ...
  import DesaRiung from '../../assets/Desa4/Riung.jpg';

  const HeroSection = () => (
    <div 
      className="relative min-h-screen"
      style={{
        backgroundImage: `url(${DesaRiung})`,
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 py-20 text-white">
        ...
        >
          ...
          >
            Selamat datang di Desa Riung, sebuah permata tersembunyi di jantung Flores, Nusa Tenggara Timur
          </motion.p>
        </motion.div>
      </div>
    </div>
