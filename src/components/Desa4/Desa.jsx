      ...
      <div className="max-w-7xl mx-auto px-8 py-24 space-y-32">
        ...
        >
          ...
          <p className="text-gray-700 text-xl leading-relaxed max-w-4xl font-light">
            Desa Riung di Flores, Nusa Tenggara Timur adalah surga tersembunyi dengan 17 pulau eksotis dan kekayaan laut yang menakjubkan. 
            Terkenal dengan Taman Nasional 17 Pulau, desa ini menawarkan pengalaman wisata bahari yang unik dengan terumbu karang yang indah, 
            kehidupan nelayan tradisional, dan budaya pesisir yang kaya.
          </p>
        </motion.div>
